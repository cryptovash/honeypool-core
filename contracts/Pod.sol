 ...
 * @notice Pods turn HoneyPool deposits into shares and enable batched deposits, reudcing gas costs and collectively increasing odds  winning.
 * @dev Pods is a ERC20 token with additional features: shares (representing deposits), batched deposits into HoneyPool PrizePools and claimable rewards.
    ...
    ReentrancyGuardUpgradeable
{
     ...
     * @dev Deposits the current float amount into the PrizePool and claims current HNYP rewards.
     */
