 ...
 * @notice Calculates distribution of HNYP rewards for users deposting into HoneyPool PrizePools using the Pod smart contract.
 * @dev A simplified version of the HoneyPool TokenFaucet that simplifies an asset token distribution using totalSupply calculations.
...
contract TokenDrop is ReentrancyGuardUpgradeable {
     ...
     * @dev Initialize TokenDrop Smart Contract with the measure (i.e. Pod) and asset (i.e. HNYP) variables
