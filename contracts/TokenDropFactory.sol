 ...
 * @notice Create a TokenDrop smart contract, which is associated with Pod smart contract for distribution of an asset token (i.e. HNYP).
...
contract TokenDropFactory is ProxyFactory {
     ...
     * @dev Creates and initializes the TokenDrop Smart Contract with the measure (i.e. Pod) and asset (i.e. HNYP) variables
